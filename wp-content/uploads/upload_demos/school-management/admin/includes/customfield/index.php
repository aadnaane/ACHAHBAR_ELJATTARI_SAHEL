...
<?php } ?>
	...
	<h2 class="nav-tab-wrapper">
		...
		<?php echo '<span class="dashicons dashicons-menu"></span>'. esc_attr__('Custom Field List', 'school-mgt'); ?></a>
       ...
       <a href="?page=custom_field&tab=add_custome_field&action=edit&id=<?php echo $_REQUEST['id'];?>" class="nav-tab margin_bottom<?php echo $active_tab == 'add_custome_field' ? 'nav-tab-active' : ''; ?>">
		<?php esc_attr_e('Edit Custom Field', 'school-mgt'); ?></a>  
		<?php 
		}
		else
		{?>
    	<a href="?page=custom_field&tab=add_custome_field" class="nav-tab margin_bottom <?php echo $active_tab == 'addexam' ? 'nav-tab-active' : ''; ?>">
		<?php echo '<span class="dashicons dashicons-plus-alt"></span>'. esc_attr__('Add Custom Field', 'school-mgt'); ?></a>  
        <?php } ?>
    </h2>
    <?php
        ...
        <tbody>
		 ...
		 ?>
            <tr>
				...
				<td class="added"><?php echo esc_attr_e($retrieved_data->field_type,'school-mgt'); ?></td>
				<td class="added"><?php echo esc_attr_e($retrieved_data->field_validation,'school-mgt'); ?></td>
                <td><a href="?page=custom_field&tab=add_custome_field&action=edit&id=<?php echo $retrieved_data->id;?>" class="btn btn-info"><?php esc_attr_e('Edit','school-mgt');?></a>
