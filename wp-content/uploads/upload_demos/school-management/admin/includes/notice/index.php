...
<?php } ?>
	...
	<h2 class="nav-tab-wrapper">
		...
		<?php echo '<span class="dashicons dashicons-menu"></span>'. esc_attr__('Notice List', 'school-mgt'); ?></a>
       ...
       <a href="?page=smgt_notice&tab=addnotice&action=edit&notice_id=<?php echo $_REQUEST['notice_id'];?>" class="nav-tab <?php echo $active_tab == 'addnotice' ? 'nav-tab-active' : ''; ?>">
		...
		<?php echo '<span class="dashicons dashicons-plus-alt"></span>'. esc_attr__('Add Notice', 'school-mgt'); ?></a>  
        <?php } ?>
    </h2>
 <?php
...
<div class="panel-body">
        ...
        <table id="notice_list" class="display" cellspacing="0" width="100%">
            ...
            <tr>       
                ...
                <th width="185px"><?php esc_attr_e('Action','school-mgt');?></th>               
            </tr>
        </thead>	
		...
		{	
		 ?>
            <tr>
                ...
                <td><?php echo esc_attr_e(get_post_meta( $retrieved_data->ID, 'notice_for',true),'school-mgt');?></td>   
                 <td>
                 <?php 
               ...
               <a href="?page=smgt_notice&tab=addnotice&action=edit&notice_id=<?php echo $retrieved_data->ID;?>"class="btn btn-info"><?php esc_attr_e('Edit','school-mgt');?></a>
