...
<div class="panel-body">   
		...
		<!-- <div class="form-group">
			<label class="col-sm-2 control-label" for="duration"><?php esc_attr_e('Duration(Minute)','school-mgt');?></label>
			<div class="col-sm-8">
				<input id="duration" class="form-control" type="text" value="<?php echo $meeting_data->duration; ?>" name="duration">
			</div>
		</div> -->
		<!-- <div class="form-group">
			<label class="col-sm-2 control-label" for="title"><?php esc_attr_e('Title','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="offset-sm-2 col-sm-8">        	
        	<input type="submit" value="<?php if($edit){ esc_attr_e('Save Meeting','school-mgt'); }else{ esc_attr_e('Create Meeting','school-mgt');}?>" name="edit_meeting" class="btn btn-success" />
        </div>        
     </form>
    </div>
    <?php
