		...
		<table class="table ">
			<thead>
				<tr>
					...
					echo mj_smgt_admininbox_pagination($totlal_message,$p,$lpm1,$prev,$next);
					?>
					</th>
				</tr>
			</thead>
			...
			{			
				...
				{	
					...
					{?>
						<tr>	
						<td><a href="?page=smgt_message&tab=view_message&from=inbox&id=<?php echo $msg->message_id;?>"  class="text_decoration_none">
						<?php 
						...
						<td class="width_400px"><a href="?page=smgt_message&tab=view_message&from=inbox&id=<?php echo $msg->message_id;?>"  class="text_decoration_none">
						<?php
				...
				{ ?>
					<tr>	
					<td><a href="?page=smgt_message&tab=view_message&from=inbox&id=<?php echo $msg->message_id;?>"  class="text_decoration_none"> <?php 
						$auth = get_post($msg->post_id);
						$authid = $auth->post_author;
						echo mj_smgt_get_display_name($authid);
						?></a></td>		
