...
<div class="panel panel-white"><!--- PANEL WHITE DIV START -->
		<h2>
			<?php echo esc_html( esc_attr__( 'Parent Access Right', 'school-mgt')); ?>
		</h2>			
				...
				<div class="access_right_menucroll row border_bottom_0">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['parent']['account']['edit'],1);?> value="1" name="account_edit" disabled>	              
								</label>
							</div>
						</div>
