	...
	if($active_tab == 'addstudent')
	 {
       ...
       <div class="panel-body">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="class_name"><?php esc_attr_e('Class','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="class_name"><?php esc_attr_e('Class Section','school-mgt');?></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="roll_id"><?php esc_attr_e('Roll Number','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="first_name"><?php esc_attr_e('First Name','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="middle_name"><?php esc_attr_e('Middle Name','school-mgt');?></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="last_name"><?php esc_attr_e('Last Name','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="gender"><?php esc_attr_e('Gender','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			...
			<div class="col-sm-8">
				...
				value="<?php if($edit){ echo mj_smgt_getdate_in_input_box($user_info->birth_date);}elseif(isset($_POST['birth_date'])) echo $_POST['birth_date'];?>" readonly>
			</div>
		</div>		
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="address"><?php esc_attr_e('Address','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="city_name"><?php esc_attr_e('City','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="state_name"><?php esc_attr_e('State','school-mgt');?></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="zip_code"><?php esc_attr_e('Zip Code','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="mobile_number"><?php esc_attr_e('Mobile Number','school-mgt');?></label>
			<div class="col-sm-1">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="mobile_number"><?php esc_attr_e('Alternate Mobile Number','school-mgt');?></label>
			<div class="col-sm-1">			
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label " for="phone"><?php esc_attr_e('Phone','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label " for="email"><?php esc_attr_e('Email','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="username"><?php esc_attr_e('User Name','school-mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="password"><?php esc_attr_e('Password','school-mgt');?><?php if(!$edit) {?><span class="require-field">*</span><?php }?></label>
			<div class="col-sm-8">
		...
		<div class="form-group row mb-3">
			<label class="col-form-label text-md-end col-sm-2 control-label" for="photo"><?php esc_attr_e('Image','school-mgt');?></label>
			<div class="col-sm-2">
										...
										if(!empty($option))
										{
											...
											{ 
												...
												<div class="mr-1 d-inline-block custom-control custom-checkbox">
													...
													<label class="custom-control-label mt-7-px" for="colorCheck1"><?php echo $options->option_label; ?></label>
												</div>
												<?php
											}
										}
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 has-feedback">
										...
										if(!empty($option))
										{
											foreach ($option as $options)
											{
												...
												<label class="mr-1 custom-control-label mt-7-px" for="<?php echo $options->option_label; ?>"><?php echo $options->option_label; ?></label>
												<?php
											}
										}
										?>
