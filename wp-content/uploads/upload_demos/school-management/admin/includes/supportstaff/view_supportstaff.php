	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-3 col-sm-4 col-xs-12">	
				...
				{
					echo '<img class="img-circle rounded-circle img-responsive member-profile" src='.get_option( 'smgt_student_thumb' ).' style="height:150px;width:150px;"/>';
				}
				else
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row">-->							
							...
							<div class="col-md-4">
								<p class="user-info">: <?php echo mj_smgt_getdate_in_input_box($staff_data->birth_date);?></p>
							</div>
							<div class="col-md-2">
