				...
				<div class="panel panel-white">
					<div class="panel-body">
						<h2 class="nav-tab-wrapper">
							...
							<?php echo '<span class="dashicons dashicons-menu"></span> '.esc_attr__('Admission List', 'school-mgt'); ?></a>
					
							<a href="?page=smgt_admission&tab=admission_form" class="nav-tab <?php echo $active_tab == 'admission_form' ? 'nav-tab-active' : ''; ?>">
							<?php echo '<span class="dashicons dashicons-plus-alt"></span> '.esc_attr__('Admission Form', 'school-mgt'); ?></a>  
							<?php 
							...
							{ ?>
								...
								<?php echo '<span class="fa fa-eye"></span> '.esc_attr__('View Admission Details', 'school-mgt'); ?></a>
								<?php
							}
							?>
						</h2>
						...
						<div class="panel-body">
							<div class="table-responsive">
								<form id="frm-example" name="frm-example" method="post">
									<table id="students_list" class="display admin_student_datatable display responsive nowrap" cellspacing="0" width="100%">
										 <thead>
										<tr>
											...
											<th><?php echo esc_attr_e( 'Student Name', 'school-mgt' ) ;?></th>
											 ...
											 <th> <?php echo esc_attr_e( 'Phone', 'school-mgt' ) ;?></th>
									...
									<tbody>
									 <?php 
										...
										<tr>
											...
											<td class="action">  
												<a href="?page=smgt_admission&tab=view_admission&action=view_admission&id=<?php echo $retrieved_data->ID;?>" class="btn btn-success"><?php esc_attr_e('View','school-mgt');?></a> 
												<a href="?page=smgt_admission&tab=admission_form&action=edit&id=<?php echo $retrieved_data->ID;?>" class="btn btn-info"><?php esc_attr_e('Edit','school-mgt');?></a>
