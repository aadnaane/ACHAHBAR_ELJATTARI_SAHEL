...
<div class="panel-body">    
	<h2 class="nav-tab-wrapper">	
		...
		<?php echo '<span class="dashicons dashicons-groups"></span>'. esc_attr__('Attendance', 'school-mgt'); ?></a>
        <a href="?page=smgt_attendence&tab=teacher_attendence" class="nav-tab <?php echo $active_tab == 'teacher_attendence' ? 'nav-tab-active' : ''; ?>">
		<?php echo '<span class="dashicons dashicons-businessman"></span>'. esc_attr__('Teacher  Attendance', 'school-mgt'); ?></a>
		...
		<?php echo '<span class="dashicons dashicons-groups"></span>'. esc_attr__('Subject Wise Attendance', 'school-mgt'); ?></a>
		<a href="?page=smgt_attendence&tab=export_attendance" class="nav-tab margin_top_attendance_qr margin_bottom <?php echo $active_tab == 'export_attendance' ? 'nav-tab-active' : ''; ?>">
			<?php echo '<span class="dashicons dashicons-groups"></span>'. esc_attr__('Export Attendance', 'school-mgt'); ?></a>	
		<a href="?page=smgt_attendence&tab=import_attendence" class="nav-tab margin_top_attendance_qr margin_bottom <?php echo $active_tab == 'import_attendence' ? 'nav-tab-active' : ''; ?>">
			<?php echo '<span class="dashicons dashicons-groups"></span>'. esc_attr__('Import Attendance', 'school-mgt'); ?></a>		
    </h2>
    <?php
	...
	{ ?>	 
		...
		<div class="form-group col-md-3 mb-3">
		 ...
		 <div class="form-group col-md-3 mb-3 button-possition">
    	<label for="subject_id">&nbsp;</label>
      	<input type="submit" value="<?php esc_attr_e('Take/View  Attendance','school-mgt');?>" name="attendence"  class="btn btn-info"/>
    </div>
	</div>
</form>
</div>
		...
		<div class="d-flex">
			...
			<div class="form-group row mb-3">
				...
				<div class="col-sm-2 ps-0">
					 <div class="checkbox">
						<label>
							<input id="smgt_mail_service_enable" type="checkbox" <?php $smgt_mail_service_enable = 0;if($smgt_mail_service_enable) echo "checked";?> value="1" name="smgt_mail_service_enable">
						</label>
					</div>				 
				</div>
			</div>
