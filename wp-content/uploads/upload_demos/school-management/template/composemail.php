...
?>
	<div class="overflow-hidden mailbox-content">
		...
		{
			?>
			<div class="mb-3 form-group row class_selection">
			...
			<div class="mb-3 form-group row multiple_class_div">
        ...
        <div id="smgt_select_class">
			<div class="mb-3 form-group row class_list_id single_class_div">
		...
		{
		?>
			<div class="mb-3 form-group row class_section_id" style="<?php echo $class_selection_id_css; ?>">
		...
		?>
		<div class="mb-3 form-group row single_class_div support_staff_user_div">
