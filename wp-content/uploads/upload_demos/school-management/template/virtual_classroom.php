...
<div class="panel-body panel-white p-4">
	<ul class="nav nav-tabs panel_tabs" role="tablist">
		<li class="nav-item">
			<a href="?dashboard=user&page=virtual_classroom&tab=meeting_list" class="nav-tab2 nav-link <?php echo $active_tab == 'meeting_list' ? 'active' : ''; ?>"> <strong>
				<i class="fa fa-align-justify"> </i> <?php esc_attr_e('Virtual Class List', 'school-mgt'); ?></strong>
			</a>
		</li>
		<?php
		...
		{?>
	     	<li class="nav-item">
			<a href="?dashboard=user&page=virtual_classroom&tab=edit_meeting" class="nav-link nav-tab2 <?php echo $active_tab == 'edit_meeting' ? 'active' : ''; ?>"> <strong>
				<i class="fa fa-align-justify"> </i> <?php esc_attr_e('Edit Virtual Class', 'school-mgt'); ?></strong>
			</a>
			</li> 
		<?php 
		}
		...
		{?>
	     	<li class="nav-item">
			<a href="?dashboard=user&page=virtual_classroom&tab=view_past_participle_list" class="nav-link nav-tab2 <?php echo $active_tab == 'view_past_participle_list' ? 'active' : ''; ?>"> <strong>
				<i class="fa fa-align-justify"> </i> <?php esc_attr_e('View Past Participle List', 'school-mgt'); ?></strong>
			</a>
			</li> 
		<?php 
		}
								...
								foreach($chil_array as $child_id)
								{
									...
									?>
										<tr>
											...
											<td><?php echo mj_smgt_get_teacher($retrieved_data->teacher_id); ?></td>
											<td><?php echo $day; ?></td>
											...
											<td> 
											<a href="<?php echo $retrieved_data->meeting_join_link;?>" class="btn btn-success" target="_blank"><i class="fa fa-video-camera" aria-hidden="true"></i> <?php esc_attr_e('Join Virtual Class','school-mgt');?> </a>
											</td>
										</tr>
									<?php 
									}
								...
								?>
									<tr>
										...
										?>
											...
											<a href="?dashboard=user&page=virtual_classroom&tab=view_past_participle_list&action=view&meeting_uuid=<?php echo $retrieved_data->uuid;?>" class="btn btn-success"><i class="fa fa-video-camera" aria-hidden="true"></i> <?php esc_attr_e('View Past Participle List','school-mgt');?> </a>
										<?php
										}
										elseif ($school_obj->role == 'student')
										{
										?> 
										<a href="<?php echo $retrieved_data->meeting_join_link;?>" class="btn btn-success" target="_blank"><i class="fa fa-video-camera" aria-hidden="true"></i> <?php esc_attr_e('Meeting Join Link','school-mgt');?> </a>
										<?php 
										}
										if($user_access['edit']=='1')
										{
										?>
											<a href="?dashboard=user&page=virtual_classroom&tab=edit_meeting&action=edit&meeting_id=<?php echo $retrieved_data->meeting_id;?>" class="btn btn-info"><?php esc_attr_e('Edit','school-mgt');?> </a>
										<?php
										}
										if($user_access['delete']=='1')
										{
										?>
											<a href="?dashboard=user&page=virtual_classroom&tab=meeting_list&action=delete&meeting_id=<?php echo $retrieved_data->meeting_id;?>" class="btn btn-danger" onclick="return confirm('<?php esc_attr_e('Are you sure you want to delete this record?','school-mgt');?>');"> <?php esc_attr_e('Delete','school-mgt');?></a>
										<?php
										}
										?> 
										</td>
						...
						else
						{
							...
							?>
								<tr>
									...
									?>
										<a href="<?php echo $retrieved_data->meeting_start_link;?>" class="btn btn-primary" target="_blank"><i class="fa fa-video-camera" aria-hidden="true"></i> <?php esc_attr_e('Start Virtual Class','school-mgt');?> </a>
										<a href="?dashboard=user&page=virtual_classroom&tab=view_past_participle_list&action=view&meeting_uuid=<?php echo $retrieved_data->uuid;?>" class="btn btn-success"><?php esc_attr_e('View Past Participle List','school-mgt');?> </a>
									<?php
									}
									elseif ($school_obj->role == 'student')
									{
	...
	?>
		<div class="panel-body">   
	        ...
	        <div class="form-group">
				<label class="col-sm-2 control-label" for="class_name"><?php esc_attr_e('Class Name','school-mgt');?></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="class_section"><?php esc_attr_e('Class Section','school-mgt');?></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="Subject"><?php esc_attr_e('Subject','school-mgt');?></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="start_time"><?php esc_attr_e('Start Time','school-mgt');?></label>
				<div class="col-sm-8">
					<input id="start_time" class="form-control" type="text" value="<?php echo $start_time; ?>" name="start_time" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="end_time"><?php esc_attr_e('End Time','school-mgt');?></label>
				<div class="col-sm-8">
					<input id="end_time" class="form-control" type="text" value="<?php echo $end_time; ?>" name="end_time" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="start_date"><?php esc_attr_e('Start Date','school-mgt');?><span class="require-field">*</span></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="end_date"><?php esc_attr_e('End Date','school-mgt');?><span class="require-field">*</span></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="agenda"><?php esc_attr_e('Topic','school-mgt');?></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="title"><?php esc_attr_e('Password','school-mgt');?></label>
				<div class="col-sm-8">
			...
			<div class="offset-sm-2 col-sm-8">        	
	        	<input type="submit" value="<?php esc_attr_e('Save Meeting','school-mgt'); ?>" name="edit_meeting" class="btn btn-success" />
	        </div>        
	     	</form>
	    </div>
	<?php
