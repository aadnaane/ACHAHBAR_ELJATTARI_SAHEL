...
<?php 
	...
	<ul class="nav nav-tabs panel_tabs" role="tablist">
		<li class="nav-item">
			<a href="?dashboard=user&page=payment&tab=paymentlist"  class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'paymentlist' ? 'active' : ''; ?>">
				<i class="fa fa-align-justify"></i> <?php esc_attr_e('Payment', 'school-mgt'); ?></a>
			</a>
		</li>
		<li class="nav-item">
		  <?php  if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' && isset($_REQUEST['payment_id']))
			{ ?>
			<a href="?dashboard=user&page=payment&tab=addinvoice&action=edit&invoice_id=<?php if(isset($_REQUEST['invoice_id'])) echo $_REQUEST['invoice_id'];?>" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'addinvoice' ? 'active' : ''; ?>">
			 <i class="fa"></i> <?php esc_attr_e('Edit Payment', 'school-mgt'); ?></a>
			 <?php 
			}
			else
			{
				...
				{ ?>
					<a href="?dashboard=user&page=payment&tab=addinvoice" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'addinvoice' ? 'active' : ''; ?>">
					<i class="fa fa-plus-circle"></i> <?php esc_attr_e('Add Payment', 'school-mgt'); ?></a>
	  <?php 	} 
			}?>
		</li>
		<li class="nav-item">
			<a href="?dashboard=user&page=payment&tab=incomelist" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'incomelist' ? 'active' : ''; ?>">
				<i class="fa fa-align-justify"></i> <?php esc_attr_e('Income List', 'school-mgt'); ?></a>
			</a>
		</li>
		<li class="nav-item">
		  <?php  if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' && isset($_REQUEST['invoice_id']))
			{?>
				<a href="?dashboard=user&page=payment&tab=addincome&action=edit&income_id=<?php if(isset($_REQUEST['income_id'])) echo $_REQUEST['income_id'];?>" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'addincome' ? 'active' : ''; ?>">
				<i class="fa"></i> <?php esc_attr_e('Edit Income', 'school-mgt'); ?></a>
			 <?php 
			 }
			else
			{
				if($user_access['add']=='1')
				{ ?>
					<a href="?dashboard=user&page=payment&tab=addincome" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'addincome' ? 'active' : ''; ?>">
					<i class="fa fa-plus-circle"></i> <?php esc_attr_e('Add Income', 'school-mgt'); ?></a>
	  <?php 	} 
			}?>
		</li>
		<li class="nav-item">
			<a href="?dashboard=user&page=payment&tab=expenselist" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'expenselist' ? 'active' : ''; ?>">
				<i class="fa fa-align-justify"></i> <?php esc_attr_e('Expense List', 'school-mgt'); ?></a>
			</a>
		</li>
		<li class="nav-item">
		  <?php  if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' && isset($_REQUEST['expense_id']))
			{?>
				<a href="?dashboard=user&page=payment&tab=addexpense&action=edit&expense_id=<?php if(isset($_REQUEST['expense_id'])) echo $_REQUEST['expense_id'];?>" class="p-2 px-3 nav-link nav-tab2 <?php echo $active_tab == 'addexpense' ? 'active' : ''; ?>">
				<i class="fa"></i> <?php esc_attr_e('Edit Expense', 'school-mgt'); ?></a>
			 <?php
			}
			else
			{
				if($user_access['add']=='1')
				{?>
					<a href="?dashboard=user&page=payment&tab=addexpense" class="p-2 px-3 nav-link nav-tab2 margin_bottom <?php echo $active_tab == 'addexpense' ? 'active' : ''; ?>">
					<i class="fa fa-plus-circle"></i> <?php esc_attr_e('Add Expense', 'school-mgt'); ?></a>
	  <?php		} 
			}?>
		</li>
	</ul>
					...
					?>
						...
						<?php if($school_obj->role == 'supportstaff')
							...
							<td width="110px"><?php echo $retrieved_data->payment_title;?></td>
							  ...
							  <td><?php echo "<span> ". mj_smgt_get_currency_symbol() ." </span>" . $retrieved_data->amount;?></td>
							   <td><?php 
							...
							<td>
								...
								{
								?>
									<a href="?dashboard=user&page=payment&tab=addinvoice&action=edit&payment_id=<?php echo $retrieved_data->payment_id;?>" class="btn btn-info"><?php esc_attr_e('Edit','school-mgt');?></a>
								<?php
								}
	...
	?>
			...
			<div class="panel-body">
			<form name="payment_form" action="" method="post" class="mt-3 form-horizontal" id="payment_form">
				...
				<tbody>
				 ...
				 ?>
						<tr>
							...
							{
							?>
								<a href="?dashboard=user&page=payment&tab=addincome&action=edit&income_id=<?php echo $retrieved_data->income_id;?>" class="btn btn-info"> <?php esc_attr_e('Edit', 'school-mgt' ) ;?></a>
							<?php
							}
							if($user_access['delete']=='1')
							{
	 ...
	 <?php
		...
		<div class="panel-body">
			...
			<?php 
				...
				if(!empty($all_entry))
				{
						...
						?>
						<div id="income_entry">
							<div class="mb-3 form-group row income_fld">
				...
				{?>
						<div id="income_entry">
							...
							<label class="col-sm-2 control-label col-form-label text-md-end" for="income_entry"><?php esc_attr_e('Income Entry','school-mgt');?><span class="require-field">*</span></label>
							<div class="col-sm-2">
								<input id="income_amount" class="form-control validate[required,min[0],maxSize[8]] text-input" type="number" step="0.01" value="" name="income_amount[]" placeholder="<?php esc_attr_e('Income Amount','school-mgt');?>">
							</div>
							<div class="col-sm-4">
								<input id="income_entry" class="form-control validate[required,custom[onlyLetter_specialcharacter]] text-input" maxlength="50" type="text" value="" name="income_entry[]" placeholder="<?php esc_attr_e('Income Entry Label','school-mgt');?>">
							</div>						
							<div class="col-sm-2">
							<button type="button" class="btn btn-default" onclick="deleteParentElement(this)">
							<i class="entypo-trash"><?php esc_attr_e('Delete','school-mgt');?></i>
		...
		<script>
		    ...
		    function add_entry()
			{
				<?php if($edit)
				{ ?>
				blank_custom_label+='<div class="mb-3 form-group row income_fld">';
				blank_custom_label+='<label class="col-sm-2 control-label col-form-label text-md-end" for="income_entry"> <?php  esc_attr_e("Income Entry", "school-mgt"); ?> <span class="require-field">*</span></label>';
				blank_custom_label+='<div class="col-sm-2">';
				blank_custom_label+='<input id="income_amount" class="form-control validate[required,min[0],maxSize[8]] text-input" type="number" step="0.01" value="" placeholder="<?php _e('Income Amount','school-mgt');?>" name="income_amount[]">';
				blank_custom_label+='</div>';
				blank_custom_label+='<div class="col-sm-4">';
				blank_custom_label+='<input id="income_entry" class="form-control validate[required,custom[onlyLetter_specialcharacter]] text-input" maxlength="50" type="text" value="" placeholder="<?php _e('Income Entry Label','school-mgt');?>" name="income_entry[]">';
				blank_custom_label+='</div>';
				blank_custom_label+='<div class="col-sm-2">';
				blank_custom_label+='<button type="button" class="btn btn-default" onclick="deleteParentElement(this)">';
				blank_custom_label+='<i class="entypo-trash"><?php  esc_attr_e("Delete","school-mgt");?></i>';
	 ...
	 $("#delete_selected").on('click', function()
		...
		<div class="panel-body">
			<div class="table-responsive">
					...
					<tbody>
					 ...
					 ?>
						<tr>
							...
							<i class="fa fa-eye"></i> <?php esc_attr_e('View Expense', 'school-mgt');?></a>
							 <?php
							if($user_access['edit']=='1')
							{
							?>
								<a href="?dashboard=user&page=payment&tab=addexpense&action=edit&expense_id=<?php echo $retrieved_data->income_id;?>" class="btn btn-info"> <?php esc_attr_e('Edit', 'school-mgt' ) ;?></a>
							<?php
							}
							if($user_access['delete']=='1')
							{
				...
				{ ?>
					<div class="print-button pull-left">
						<input id="delete_selected" type="submit" value="<?php esc_attr_e('Delete Selected','school-mgt');?>" name="delete_selected_expense" class="btn btn-danger delete_selected"/>
					</div>
				<?php
				}  ?>
				</form>
		...
		<div class="panel-body">
			...
			<?php 
				...
				{?>
						<div id="expense_entry">
							...
							<label class="col-sm-2 control-label col-form-label text-md-end" for="income_entry"><?php esc_attr_e('Expense Entry','school-mgt');?><span class="require-field">*</span></label>
							<div class="col-sm-2">
								<input id="income_amount" class="form-control validate[required,min[0],maxSize[8]] text-input" type="number" step="0.01" value="" name="income_amount[]" placeholder="<?php esc_attr_e('Expense Amount','school-mgt');?>">
							</div>
							<div class="col-sm-4">
								<input id="income_entry" class="form-control validate[required,custom[onlyLetter_specialcharacter]] text-input" maxlength="50" type="text" value="" name="income_entry[]" placeholder="<?php esc_attr_e('Expense Entry Label','school-mgt');?>">
							</div>
			...
			<div class="mb-3 form-group row">
				...
				<div class="col-sm-3">
					...
					<button id="add_new_entry" class="btn btn-default btn-sm btn-icon icon-left" type="button"   name="add_new_entry" onclick="add_entry()"><?php esc_attr_e('Add Expense Entry','school-mgt'); ?>
					</button>
				</div>
			</div>
			<hr>
			...
			{	
			   ...
			   { ?> 			
				...
				blank_custom_label+='<label class="col-sm-2 control-label col-form-label text-md-end" for="income_entry"><?php esc_html_e("Expense Entry","school-mgt");?><span class="require-field">*</span></label>';
				blank_custom_label+='<div class="col-sm-2">';
				blank_custom_label+='<input id="income_amount" class="form-control amt validate[required,min[0],maxSize[8]] text-input" placeholder="<?php esc_attr_e('Expense Amount','school-mgt');?>" type="number" step="0.01" value="" name="income_amount[]" >';
				blank_custom_label+='</div>';
				blank_custom_label+='<div class="col-sm-4">';
				blank_custom_label+='<input id="income_entry" class="form-control entry validate[required,custom[onlyLetter_specialcharacter]] text-input" maxlength="50" type="text" value="" placeholder="<?php esc_attr_e('Expense Entry Label','school-mgt');?>" name="income_entry[]">';
				blank_custom_label+='</div>';
				blank_custom_label+='<div class="col-sm-2">';
				blank_custom_label+='<button type="button" class="btn btn-default" onclick="deleteParentElement(this)">';
				blank_custom_label+='<i class="entypo-trash"><?php esc_html_e("Delete","school-mgt");?></i>';
				blank_custom_label+='</button>';
				blank_custom_label+='</div>';
				blank_custom_label+='</div>';
