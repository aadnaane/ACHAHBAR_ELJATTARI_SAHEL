		...
		if(!empty($assigned_data)){
			...
			$i=0;
				...
				foreach ($assigned_data as $retrieved_data){
						...
						$classname=mj_smgt_get_class_name($retrieved_data['class_id']);

						$subjectname=mj_smgt_get_single_subject_name($retrieved_data['subject_id']);
						...
						if(isset($retrieved_data['section_id']) && $retrieved_data['section_id']!=0){
								...
								$section=mj_smgt_get_section_name($retrieved_data['section_id']); 
