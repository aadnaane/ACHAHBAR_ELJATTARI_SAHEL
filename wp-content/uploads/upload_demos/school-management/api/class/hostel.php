		...
		{				
			...
			{				
				...
				{					
					...
					$room_data= mj_smgt_get_rooms_by_hostel_id($hostel_id);
					...
					$bed_data= mj_smgt_get_beds_by_hostel_id($hostel_id);
...

	{
		...
		if($role=='student'){			
...

			{
				...
				$all_exam	= mj_smgt_get_rooms_by_hostel_id($hostel_id);	
			...
			{				
				...
				{					
					...
					$exam_array	=	array(
						...
						'hostel_name'	=>mj_smgt_get_hostel_name_by_id($retrieved_data->hostel_id),
...

	{
		...
		if($role=='student'){			
...

			{
				...
				$all_exam	= mj_smgt_get_beds_by_room_id($room_id);
		...
		{				
			...
			{				
				...
				$hostel_name= mj_smgt_get_hostel_name_by_room_id($room_id);
				...
				{					
					...
					$exam_array	=	array(
						...
						'room_id'	=>mj_smgt_get_room_unique_id_by_id($retrieved_data->room_id),
