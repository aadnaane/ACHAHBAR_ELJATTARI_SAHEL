...
class TeacherListing 
{
	...
	public function teacher_listing($data)
	{
		...
		//Get User Acsess //
		$menu_access_data=mj_smgt_get_userrole_wise_access_right_array_in_api($data['current_user'],'teacher');
		...
		{	
...

			{
				...
				$subjectname=rtrim(mj_smgt_get_subject_name_by_teacher($retrieved_data->ID),', ');
