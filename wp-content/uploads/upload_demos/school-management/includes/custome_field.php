...
{  /*<---START Lmgt_custome_field  CLASS--->*/
	...
	function mj_smgt_get_all_custom_field_data()
	{
		global $wpdb;
		$wpnc_custom_fields = $wpdb->prefix . 'custom_field';
		$get_custom_field_data = $wpdb->get_results("SELECT * FROM $wpnc_custom_fields where field_visibility!=2 ORDER BY created_at DESC");
		return $get_custom_field_data;
	}
	//Get Single Custom Field Data Function//
	function mj_smgt_get_single_custom_field_data($custom_fields_id)
	{
		global $wpdb;
		$wpnc_custom_fields = $wpdb->prefix . 'custom_field';
	...
	function mj_smgt_get_single_custom_field_dropdown_meta_data($custom_field_id)
	{
		global $wpdb;
		$wpnc_custom_field_dropdown_metas = $wpdb->prefix . 'custom_field_dropdown_metas';
	...
	function mj_smgt_get_single_custom_field_meta_value($module,$module_record_id,$custom_field_id) 
	{	
		global $wpdb;
	...
	function mj_smgt_getDropDownValue($custom_field_id) 
	{		
		global $wpdb;
		$wpnc_custom_field_dropdown_metas = $wpdb->prefix . 'custom_field_dropdown_metas';
	...
	function mj_smgt_getCheckedCheckbox($custom_field_id)
	{
		global $wpdb;
		$wpnc_custom_fields = $wpdb->prefix . 'custom_field';
	...
	function mj_smgt_check_field_old_or_new($module,$module_record_id,$custom_field_id)
	{
		global $wpdb;
		$wpnc_custom_field_metas = $wpdb->prefix . 'custom_field_metas';
