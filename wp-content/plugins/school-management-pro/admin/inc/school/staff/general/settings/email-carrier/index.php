	...
	<div class="row">
		...
		<div class="col-md-5">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item">
					<span class="text-danger wlsm-font-bold"><?php esc_html_e('Lastly, you will need to allow less secure app in your Gmail account.', 'school-management'); ?></span>
					<a target="_blank" href="https://myaccount.google.com/lesssecureapps?pli=1" class="text-primary">https://myaccount.google.com/lesssecureapps?pli=1</a><br>
					<a target="_blank" href="https://accounts.google.com/UnlockCaptcha" class="text-primary">https://accounts.google.com/UnlockCaptcha</a>
				</li>
			</ul>
		</div>
	</div>
