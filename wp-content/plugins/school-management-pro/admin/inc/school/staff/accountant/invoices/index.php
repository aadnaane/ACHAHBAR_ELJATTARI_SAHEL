					...
					<div class="wlsm-fee-invoices-amount-total">
						...
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item">
								...
								<span><?php echo esc_html( WLSM_Config::get_money_text( $total_payment_received, $school_id ) ); ?></span>
							</li>
							<?php } ?>
							<li class="list-group-item">
								<span class="wlsm-font-bold">
								...
								<span><?php echo esc_html( WLSM_Config::get_money_text( $invoices_pending_amount, $school_id ) ); ?></span>
							</li>
						</ul>
					</div>
				</div>
