...
<div class="wlsm-container d-flex mb-2">
	<div class="col-md-12 wlsm-text-center">
		<br>
		<button type="button" class="<?php echo esc_attr( $print_button_classes ); ?>" id="wlsm-print-id-card-btn" data-styles='["<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/bootstrap.min.css' ); ?>","<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/wlsm-school-header.css' ); ?>","<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/print/wlsm-id-card.css' ); ?>"]' data-title="<?php
		printf(
		...
		?>"><?php esc_html_e( 'Print ID Card', 'school-management' ); ?>
		</button>
	</div>
</div>

<!-- Print ID card section. -->
<div class="wlsm-container wlsm" id="wlsm-print-id-card">
