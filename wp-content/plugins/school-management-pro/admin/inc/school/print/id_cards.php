...
<div class="wlsm-container d-flex mb-2">
	<div class="col-md-12 wlsm-text-center">
		<br>
		<button type="button" class="<?php echo esc_attr( $print_button_classes ); ?>" id="wlsm-print-id-cards-btn" data-styles='["<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/bootstrap.min.css' ); ?>","<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/wlsm-school-header.css' ); ?>","<?php echo esc_url( WLSM_PLUGIN_URL . 'assets/css/print/wlsm-id-cards.css' ); ?>"]' data-title="<?php
		printf(
			/* translators: 1: class label, 2: section label */
			esc_attr__( 'ID Cards - Class: %1$s, Section: (%2$s)', 'school-management' ),
...
<div class="wlsm-container wlsm" id="wlsm-print-id-cards">
