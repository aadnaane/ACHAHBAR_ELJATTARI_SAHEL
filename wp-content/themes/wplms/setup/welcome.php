...
class WPLMS_Admin_Welcome {
	...
	public function welcome_screen(){
		...
		<div class="welcome_slider">
		  	...
		  	<div class="slides">
		  		<div id="slide-1">
		    		<img src="https://vt-tfimages.s3.amazonaws.com/mlearning_wordpress_lms.gif" />
			    </div>
			    
			    <div id="slide-2">
		    		<img src="https://vt-tfimages.s3.amazonaws.com/wp_lms_mobile_app.png" />
			    </div>
			    <div id="slide-3">
		    		<img src="https://vt-tfimages.s3.amazonaws.com/gamification.png" />
			    </div>
		  	</div>
